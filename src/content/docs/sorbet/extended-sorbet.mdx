...
![Activate Camera](@/assets/images/sorbet/sorbet_6_1.png)
...
![Website’s request for camera access](@/assets/images/sorbet/sorbet_6_2.png)
...
<div role="alert" class="alert shadow-lg">
    ...
    <div class="not-content">
        <div class="text-lg font-bold">Keep in mind</div>
        <div class="!m-0">
            In order to ensure that the hand recognition through your camera
            ...
            <span class="text-xs leading-none">
                The filed of view of a typical laptop's webcam can vary
                depending on the specific make and model of the laptop.
            </span>
        </div>
    </div>
</div>
...
<div role="alert" class="alert shadow-lg">
    ...
    <div class="not-content leading-normal">
        ...
        <p>
            ...
            together at once but with a higher rate than they would if the level
            was 34.
        </p>
...
<div class="flex flex-col items-center gap-x-4 sm:flex-row">
    <Image
        ...
        class="shadow"
    />
    <div role="alert" class="alert !mt-0 shadow-lg">
        <div class="not-content leading-normal">
...
<div class="not-content mb-16 grid grid-cols-1 items-center gap-x-4 gap-y-8 sm:grid-cols-2">
    <div>
        ...
        Click on the block you want from the blocks library and drop it in the position
        you want into the programming area.
    </div>
    ...
    <div>
        ...
        To copy a single block or a set of connected blocks right click on it/them
        and select <b>Duplicate</b>
    </div>
