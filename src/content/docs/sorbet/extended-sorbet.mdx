...
the request to use the <b>camera</b> and <b>microphone</b>. Click on <kbd class="kbd">Allow</kbd> to give access.
...
<div class="flex flex-col flex-nowrap items-center gap-x-4 sm:flex-row">
	<div>
		...
		<ul>
			<li>
				<b>"Faster"</b>: It adds 20 to the current value of the falling objects' speed
			</li>
			<li>
				<b>"Slower"</b>: It subtracts 20 from the current value of the falling objects' speed
			</li>
			<li>
				<b>"More"</b>: It adds 20 to the current value of the falling objects' density
			</li>
			<li>
				<b>"Less"</b>: It subtracts 20 from the current value of the falling objects' density
			</li>
		</ul>
	</div>
</div>
<Aside>
	<div class="!m-0">
		Be sure that you have given access to your device's microphone to use this feature in a relatively calm environment with non-overlapping voices.
	</div>
</Aside>
...
The initial values already set by the game are **25** for speed and **30** for density.
Thus, choosing **lower values decreases** the speed or density respectively, and
choosing **higher values increases** them.

<Aside>
	<p>
		Keep in mind that the speed values are not absolute but relative to the
		previous value of the variable.
	</p>
	<p>
		Density values are percentage values and are related to the remaining number of objects in the game.
	</p>
	<p>
		E.g. if you set the density level to "50" and the total amount of objects is 30, 15 items will appear in each drop (50% of 30). Setting the density to "100" will show all the remaining objects together at once.
	</p>
